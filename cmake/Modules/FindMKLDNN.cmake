...
ELSE(MKL_FOUND)
  ...
  IF(USE_MKLDNN_CBLAS AND CPU_POWER)
    IF(BLAS_INFO STREQUAL "open" AND USE_BLAS)
      SET(DNNL_BLAS_VENDOR "OPENBLAS" CACHE STRING "" FORCE)
      LIST(APPEND MKLDNN_LIBRARIES ${BLAS_LIBRARIES})
      LIST(APPEND MKLDNN_INCLUDE_DIR ${BLAS_INCLUDE_DIR})
    ENDIF(BLAS_INFO STREQUAL "open" AND USE_BLAS)
  ENDIF(USE_MKLDNN_CBLAS AND CPU_POWER)
ENDIF(MKL_FOUND)
